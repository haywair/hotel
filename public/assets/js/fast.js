define(['jquery', 'bootstrap', 'toastr', 'layer', 'lang'], function ($, undefined, Toastr, Layer, Lang) {
    var Fast = {
        ...
        api: {
                ...
                options = $.extend({
                    ...
                    success: function (ret) {
                        ...
                        if (ret.code === 1) {
                            ...
                            var successDo = setTimeout(function(){window.location.reload();},3000);
                        } else {
            ...
            //打开一个弹出窗口
            addTab: function (url, title, options) {
                title = title ? title : "";
                url = Fast.api.fixurl(url);
            ...
            getLatLng:function (city,directionName,mapDom,latDomId,lngDomId,lat,lng){
            ...
            showMaps:function(direction,mapDom){
            ...
            getCitys:function(provincedom,citydom){
                $('#'+provincedom).change(function(){
                    ...
                    $.ajax({
                        ...
                        success:function(result){
                            ...
                            var citys = [];
                            var html  = '';
                            html += '<option value="" selected="selected">请选择城市</option>';
