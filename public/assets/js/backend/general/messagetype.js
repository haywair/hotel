define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'general/messagetype/index',
                    add_url: 'general/messagetype/add',
                    edit_url: 'general/messagetype/edit',
                    del_url: 'general/messagetype/del',
                    multi_url: 'general/messagetype/multi',
                    table: 'messagetype',
                }
            });
