define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'general/replacedsource/index',
                    add_url: 'general/replacedsource/add',
                    edit_url: 'general/replacedsource/edit',
                    del_url: 'general/replacedsource/del',
                    multi_url: 'general/replacedsource/multi',
                    table: 'image_class',
                }
            });
