define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'general/help/index',
                    add_url: 'general/help/add',
                    edit_url: 'general/help/edit',
                    del_url: 'general/help/del',
                    multi_url: 'general/help/multi',
                    table: 'help',
                }
            });
