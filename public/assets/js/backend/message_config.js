define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'message_config/index',
                    add_url: 'message_config/add',
                    edit_url: 'message_config/edit',
                    del_url: 'message_config/del',
                    multi_url: 'message_config/multi',
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'name', title: __('类型'),operate:false},
