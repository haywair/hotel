...
define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'bill_clean/index',
                    add_url: '',
                    edit_url: 'bill_clean/edit',
                    del_url: 'bill_clean/del',
                    more_url:'bill_clean/more',
                    multi_url: 'bill_clean/multi',
                    table: 'bill_clean',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'clean_money', title: __('结算金额')},
                        {field: 'user_nickname', title: __('保洁员')},
